...
public class BinaryTreeUtils {
  ...
  private static <T extends Comparable<T>> void preOrderTraversal(
      BinaryTreeNode<T> root, List<T> collector) {
    if (root != null) {
  ...
  public static <T extends Comparable<T>> List<T> preOrderTraversalWithNull(
      BinaryTreeNode<T> root) {
    List<T> collector = new ArrayList<>();
    preOrderTraversalWithNull(root, collector);
    return collector;
  }

  private static <T extends Comparable<T>> void preOrderTraversalWithNull(
      BinaryTreeNode<T> root, List<T> collector) {
  ...
  public static <T extends Comparable<T>> List<T> postOrderTraversal(
      BinaryTreeNode<T> root, int max) {
    List<T> collector = new ArrayList<>();
    postOrderTraversal(root, collector, max);
    return collector;
  }

  private static <T extends Comparable<T>> void postOrderTraversal(
      BinaryTreeNode<T> root, List<T> collector, int max) {
    if (root != null) {
  ...
  public static <T extends Comparable<T>> List<T> postOrderTraversalWithNull(
      BinaryTreeNode<T> root) {
    return postOrderTraversalWithNull(root, -1);
  }

  public static <T extends Comparable<T>> List<T> postOrderTraversalWithNull(
      BinaryTreeNode<T> root, int max) {
    List<T> collector = new ArrayList<>();
    postOrderTraversalWithNull(root, collector, max);
    return collector;
  }

  private static <T extends Comparable<T>> void postOrderTraversalWithNull(
      BinaryTreeNode<T> root, List<T> collector, int max) {
    T data = root==null ? null :root.data;
    if (root != null) {
      postOrderTraversalWithNull(root.left, collector, max);
      postOrderTraversalWithNull(root.right, collector, max);
  ...
  public static <T extends Comparable<T>> List<T> preOrderTraversal(
  ...
  public static <T extends Comparable<T>> List<T> inOrderTraversal(
      BinaryTreeNodeWithParent<T> root) {
    ArrayList<T> list = new ArrayList<>();
    if (root == null) {
      return list;
   ...
   * @return
   */
  public static <T extends Comparable<T>> BinaryTreeNodeWithParent<T> getPreOrderSuccessor(
      BinaryTreeNodeWithParent<T> root) {
    if (root == null) {
      return null;
    }
   ...
   * @return
   */
  public static <T extends Comparable<T>> BinaryTreeNodeWithParent<T> getInOrderSuccessor(
      BinaryTreeNodeWithParent<T> root) {
    if (root.right != null) {
   ...
   * @return
   */
  public static <T extends Comparable<T>> BinaryTreeNodeWithParent<T> getPostOrderSuccessor(
      BinaryTreeNodeWithParent<T> root) {
    if (root == null) {
      return null;
    }
  ...
  public static <T extends Comparable<T>> BinaryTreeNodeWithParent<T> getDeepestChild(
      BinaryTreeNodeWithParent<T> root) {
    BinaryTreeNodeWithParent<T> current = root;
  ...
  public static <T extends Comparable<T>> BinaryTreeNode<T> getDeepestChild(
      BinaryTreeNode<T> root) {
  ...
  public static <T extends Comparable<T>> BinaryTreeNodeWithParent<T> getMinNode(
      BinaryTreeNodeWithParent<T> root) {
    if (root == null) {
      return null;
    }
  ...
  public static <T extends Comparable<T>> BinaryTreeNode<T> findFirstNodeEqualOrBigger(
      BinaryTreeNode<T> root, T value) {
  ...
  public static <T extends Comparable<T>> BinaryTreeNode<T> findLastNodeEqualOrSmaller(
      BinaryTreeNode<T> root, T low) {
    BinaryTreeNode<T> node = null;
    while (root != null) {
  ...
  public static <T extends Comparable<T>> BinaryTreeNode<T> getInOrderSuccessor(
      BinaryTreeNode<T> root, BinaryTreeNode<T> node) {
